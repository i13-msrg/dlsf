...
import dev.salis.dlsf.x.bitcointxprotocols.pod.node.ErlayNode;
import dev.salis.dlsf.x.bitcointxprotocols.reducer.Reducer;
import java.util.Collection;
import java.util.Collections;
import java.util.function.Function;

public class TxErlayTemplate extends AbstractSimulationTemplate {

  @Override
  public String getName() {
    return "bitcoin-tx-erlay";
  }

  @Override
  public Function<PodContext, Behavior<Message>> getPodFactory() {
    return simulationContext -> {
      return Pod.createBehavior(simulationContext, ErlayNode::createBehavior);
    };
  }
